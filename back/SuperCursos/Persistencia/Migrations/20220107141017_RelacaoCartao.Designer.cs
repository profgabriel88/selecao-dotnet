...
namespace SuperCursos.Persistencia.Migrations
{
    ...
    [Migration("20220107141017_RelacaoCartao")]
    partial class RelacaoCartao
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SuperCursos.Models.EstudanteCurso", b =>
                {
                    b.HasOne("SuperCursos.Models.Curso", "Curso")
                        .WithMany()
                        .HasForeignKey("CursoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SuperCursos.Models.Estudante", "Estudante")
                        .WithMany()
